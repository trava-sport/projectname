...
class WBIncomes(models.Model):
    ...
    date = fields.Char('Date of receipt', readonly=True)
    last_change_date = fields.Char('Date and time when the information was updated in service', readonly=True)
    ...
    date_close = fields.Char('Date of acceptance (closing) with us', readonly=True)
